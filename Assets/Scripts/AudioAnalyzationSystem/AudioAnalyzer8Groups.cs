...
{
    [AddComponentMenu(nameof(AudioAnalyzationSystem) + "/" + nameof(AudioAnalyzer8Groups))]
    public class AudioAnalyzer8Groups : MonoBehaviour, IAudioAnalyzer
    {
        ...
        private void FixedUpdate()
        {
            ...
            AudioAnalyzer.CreateFrequencyFor8Groups(ref _frequencyValues, _leftChannelSamples, _rightChannelSamples);
