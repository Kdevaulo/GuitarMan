...
namespace GuitarMan.Utils
{
    public static class ArrayUtils
    {
        ...
        public static void CheckingForEqualArraysLengths(int value0, int value1, int value2, int value3, int value4)
        {
            Assert.IsTrue(value0 == value1 && value1 == value2 && value2 == value3 && value3 == value4, ErrorString);
        }
